...
def generateData(data):
		#Creating a list to store binay form of the data using their ascii values of characters
		newdata = []
		for i in data:
...
def encode():
	...
	new_image_name = input("Enter the name of new image with extension : ")
...
def main():
	...
	if (choice == 1):
		...
		print("Decoded Message from the encoded image : " + decode())
	else:
		raise Exception("Enter correct input format")
#Function to call main function /Driver code
